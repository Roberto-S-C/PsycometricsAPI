...
class AnalysisSerializer(serializers.Serializer):
    ...
    interests = serializers.DictField()
    frustration_tolerance = serializers.DictField()
    psychological_health = serializers.DictField()

class EnhancedResultSerializer(ResultSerializer):
